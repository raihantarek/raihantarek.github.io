...
- `funFact` — a lighthearted "equivalent time" line (e.g. movies watched)
...
- The "fun fact" section replaces the original's "top X% of couples"
  claim with an honest, customizable equivalence — pick whatever's true
  and fun for you two.
